...
impl GltfCamera {
    ...
    pub fn get_camera(&self) -> CameraDescriptor {
...
mod test {
    use crate::{
        camera::CameraDescriptor, material::MaterialDescriptor, stage::Vertex, test::BlockOnFuture,
    ...
    fn gltf_images() {
        ...
        let (_vertices, _indices, _transform, _renderlet) = stage
            .builder()
            .with_material(&material)
            .with_vertices([
                Vertex::default()
