...
fn function() {
    ...
    let _e19 = phi_129_;
    let _e20 = textureSample(global_3, global, _e19);
    global_1 = vec4<f32>(_e20.x, _e20.y, _e20.z, 1f);
    return;
}

@fragment 
fn skyboxfragment_cubemap(@location(0) param: vec3<f32>) -> @location(0) vec4<f32> {
    global_2 = param;
    function();
    let _e3 = global_1;
    return _e3;
