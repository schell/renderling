...
mod target {
    pub const ENTRY_POINT: &str = "cubemap::cubemap_sampling_test_fragment";
    pub fn descriptor() -> wgpu::ShaderModuleDescriptor<'static> {
        wgpu::include_spirv!("../../shaders/cubemap-cubemap_sampling_test_fragment.spv")
    }
...
mod target {
    pub const ENTRY_POINT: &str = "cubemapcubemap_sampling_test_fragment";
    pub fn descriptor() -> wgpu::ShaderModuleDescriptor<'static> {
        wgpu::include_wgsl!("../../shaders/cubemap-cubemap_sampling_test_fragment.wgsl")
    }
    pub fn linkage(device: &wgpu::Device) -> super::ShaderLinkage {
        log::debug!(
