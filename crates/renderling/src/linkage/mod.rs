...
//!
//! To add a new shader:
//! * add a new module to renedrling-shader with your vertex and fragment functions
//! * add a new shader crate to shaders/ with a wrapper for your shader code from step one
...
//! * add whatever linkage you may need on the wgpu side to renderling/src/linkage
