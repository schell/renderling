...
mod target {
    pub const ENTRY_POINT: &str = "atlas::atlas_blit_fragment";
    pub fn descriptor() -> wgpu::ShaderModuleDescriptor<'static> {
        wgpu::include_spirv!("../../shaders/atlas-atlas_blit_fragment.spv")
    }
...
mod target {
    pub const ENTRY_POINT: &str = "atlasatlas_blit_fragment";
    pub fn descriptor() -> wgpu::ShaderModuleDescriptor<'static> {
        wgpu::include_wgsl!("../../shaders/atlas-atlas_blit_fragment.wgsl")
    }
    pub fn linkage(device: &wgpu::Device) -> super::ShaderLinkage {
