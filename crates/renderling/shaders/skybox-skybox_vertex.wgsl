...
fn function() {
    ...
    var phi_743_: bool;
    var phi_301_: type_12;
    var phi_302_: type_12;
    var phi_325_: type_12;
    var phi_352_: bool;
    var phi_358_: type_12;
    var phi_359_: type_12;
    var phi_382_: type_12;
    var phi_405_: bool;
    ...
    switch bitcast<i32>(0u) {
        default: {
            ...
            if _e89 {
                ...
                phi_301_ = type_12(0u, 6u);
                loop {
                    let _e277 = phi_301_;
                    if (_e277.member < _e277.member_1) {
                        phi_302_ = type_12((_e277.member + 1u), _e277.member_1);
                        phi_325_ = type_12(1u, _e277.member);
                    } else {
                        phi_302_ = _e277;
                        phi_325_ = type_12(0u, type_12().member_1);
                    }
                    let _e290 = phi_302_;
                    let _e292 = phi_325_;
                ...
                phi_358_ = type_12(0u, 8u);
                loop {
                    let _e325 = phi_358_;
                    if (_e325.member < _e325.member_1) {
                        phi_359_ = type_12((_e325.member + 1u), _e325.member_1);
                        phi_382_ = type_12(1u, _e325.member);
                    } else {
                        phi_359_ = _e325;
                        phi_382_ = type_12(0u, type_12().member_1);
                    }
                    let _e338 = phi_359_;
                    let _e340 = phi_382_;
                ...
                phi_426_ = type_22(type_20(vec4<f32>(bitcast<f32>(_e92), bitcast<f32>(_e97), bitcast<f32>(_e102), bitcast<f32>(_e107)), vec4<f32>(bitcast<f32>(_e113), bitcast<f32>(_e118), bitcast<f32>(_e123), bitcast<f32>(_e128)), vec4<f32>(bitcast<f32>(_e134), bitcast<f32>(_e139), bitcast<f32>(_e144), bitcast<f32>(_e149)), vec4<f32>(bitcast<f32>(_e155), bitcast<f32>(_e160), bitcast<f32>(_e165), bitcast<f32>(_e170))), type_20(vec4<f32>(bitcast<f32>(_e177), bitcast<f32>(_e182), bitcast<f32>(_e187), bitcast<f32>(_e192)), vec4<f32>(bitcast<f32>(_e198), bitcast<f32>(_e203), bitcast<f32>(_e208), bitcast<f32>(_e213)), vec4<f32>(bitcast<f32>(_e219), bitcast<f32>(_e224), bitcast<f32>(_e229), bitcast<f32>(_e234)), vec4<f32>(bitcast<f32>(_e240), bitcast<f32>(_e245), bitcast<f32>(_e250), bitcast<f32>(_e255))), vec3<f32>(bitcast<f32>(_e262), bitcast<f32>(_e267), bitcast<f32>(_e272)), type_21(_e365, _e322, vec3<f32>(bitcast<f32>(_e369), bitcast<f32>(_e374), bitcast<f32>(_e379))));
            } else {
                phi_426_ = type_22(type_20(vec4<f32>(1f, 0f, 0f, 0f), vec4<f32>(0f, 1f, 0f, 0f), vec4<f32>(0f, 0f, 1f, 0f), vec4<f32>(0f, 0f, 0f, 1f)), type_20(vec4<f32>(1f, 0f, 0f, 0f), vec4<f32>(0f, 1f, 0f, 0f), vec4<f32>(0f, 0f, 1f, 0f), vec4<f32>(0f, 0f, 0f, 1f)), vec3<f32>(0f, 0f, 0f), type_21(array<vec3<f32>, 8>(vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f)), array<vec4<f32>, 6>(vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f)), vec3<f32>(0f, 0f, 0f)));
            }
            let _e385 = phi_426_;
