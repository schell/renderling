...
fn function() {
    ...
    var phi_2579_: bool;
    var phi_2644_: vec4<f32>;
    var phi_2674_: vec4<f32>;
    var phi_2676_: vec4<f32>;
    var phi_2685_: type_17;
    var phi_2686_: type_17;
    var phi_2691_: type_17;
    var phi_2692_: type_17;
    var phi_2693_: bool;
    var phi_2697_: type_17;
            ...
            if (_e69 == 1u) {
                    ...
                    switch bitcast<i32>(_e313.member) {
                        ...
                        case 1: {
                            ...
                            if (_e131 >= _e336.member_1) {
                                phi_2300_ = 4294967295u;
                            } else {
                                phi_2300_ = (_e336.member + (9u * _e131));
                            }
                            let _e343 = phi_2300_;
                            if (_e66 >= 9u) {
                                phi_2319_ = (_e343 <= (_e66 - 9u));
                            } else {
                                phi_2319_ = false;
                            }
                            let _e348 = phi_2319_;
                ...
                if (_e493 == 1u) {
                    ...
                    if _e496 {
                        ...
                        if (_e1144 == 0f) {
                            phi_2691_ = type_17(vec3<f32>(1f, 1f, 1f), vec4<f32>(0f, 0f, 0f, 1f), vec3<f32>(0f, 0f, 0f));
                            phi_2692_ = type_17();
                            phi_2693_ = true;
                        } else {
                            ...
                            if (_e1153 != 0f) {
                                phi_2579_ = select(true, false, (_e1158 != 0f));
                            } else {
                                phi_2579_ = true;
                            }
                            let _e1170 = phi_2579_;
                            ...
                            if _e1171 {
                                ...
                                if ((_e1084.member_2.z * _e1174) <= 0f) {
                                    ...
                                    if (_e1214 <= 0f) {
                                        ...
                                        phi_2674_ = vec4<f32>((_e1230 * _e1232), (fma(_e1084.member.y, _e1172, _e1177) * _e1232), (fma(_e1084.member.z, _e1172, _e1178) * _e1232), (fma(_e1084.member_1.z, _e1173, -(_e1179)) * _e1232));
                                    } else {
                                        let _e1218 = (_e1216 + _e1214);
                                        let _e1220 = (0.5f / sqrt(_e1218));
                                        phi_2674_ = vec4<f32>((fma(_e1084.member.y, _e1172, _e1177) * _e1220), (_e1218 * _e1220), (fma(_e1084.member_1.z, _e1173, _e1179) * _e1220), (fma(_e1084.member_2.x, _e1174, -(_e1176)) * _e1220));
                                    }
                                    let _e1243 = phi_2674_;
                                    phi_2676_ = _e1243;
                                } else {
                                    ...
                                    if (_e1182 <= 0f) {
                                        ...
                                        phi_2644_ = vec4<f32>((fma(_e1084.member.z, _e1172, _e1178) * _e1201), (fma(_e1084.member_1.z, _e1173, _e1179) * _e1201), (_e1199 * _e1201), (fma(_e1084.member.y, _e1172, -(_e1177)) * _e1201));
                                    } else {
                                        let _e1185 = (_e1183 + _e1182);
                                        let _e1187 = (0.5f / sqrt(_e1185));
                                        phi_2644_ = vec4<f32>((fma(_e1084.member_1.z, _e1173, -(_e1179)) * _e1187), (fma(_e1084.member_2.x, _e1174, -(_e1176)) * _e1187), (fma(_e1084.member.y, _e1172, -(_e1177)) * _e1187), (_e1185 * _e1187));
                                    }
                                    let _e1212 = phi_2644_;
                                    phi_2676_ = _e1212;
                                }
                                let _e1245 = phi_2676_;
                                phi_2685_ = type_17(vec3<f32>(_e1153, _e1158, _e1163), _e1245, vec3<f32>(_e1084.member_3.x, _e1084.member_3.y, _e1084.member_3.z));
                                phi_2686_ = type_17();
                            } else {
                                phi_2685_ = type_17();
                                phi_2686_ = type_17(vec3<f32>(1f, 1f, 1f), vec4<f32>(0f, 0f, 0f, 1f), vec3<f32>(0f, 0f, 0f));
                            }
                            let _e1249 = phi_2685_;
                            let _e1251 = phi_2686_;
                            phi_2691_ = _e1251;
                            phi_2692_ = _e1249;
                            phi_2693_ = select(true, false, _e1171);
                        }
                        let _e1254 = phi_2691_;
                        let _e1256 = phi_2692_;
                        let _e1258 = phi_2693_;
                        if _e1258 {
                            phi_2697_ = _e1254;
                        } else {
                            phi_2697_ = _e1256;
                        }
                        let _e1260 = phi_2697_;
                ...
                if _e1271 {
                    if (_e66 >= 10u) {
                        phi_2791_ = (_e90 <= (_e66 - 10u));
                    } else {
                        phi_2791_ = false;
                    }
                    let _e1276 = phi_2791_;
                    if _e1276 {
                ...
                if (_e1408 >= _e1415) {
                    phi_1644_ = 4294967295u;
                } else {
                    phi_1644_ = (_e1411 + (16u * _e1408));
                }
                let _e1420 = phi_1644_;
