...
fn function() {
    ...
    var phi_796_: bool;
    var phi_165_: type_12;
    var phi_824_: bool;
    var phi_326_: type_12;
    var phi_327_: type_12;
    var phi_350_: type_12;
    var phi_377_: bool;
    var phi_383_: type_12;
    var phi_384_: type_12;
    var phi_407_: type_12;
    var phi_430_: bool;
    var phi_451_: type_23;
    var phi_856_: bool;
    var phi_459_: f32;
    ...
    switch bitcast<i32>(0u) {
        default: {
            let _e84 = global_2;
            let _e85 = global;
            let _e87 = arrayLength((&global_1.member));
            ...
            let _e95 = phi_796_;
            if _e95 {
                let _e98 = global_1.member[_e84];
                let _e102 = global_1.member[(_e84 + 1u)];
                phi_165_ = type_12(_e98, _e102);
            } else {
                phi_165_ = type_12(4294967295u, 4294967295u);
            }
            let _e105 = phi_165_;
            if (_e87 >= 86u) {
            ...
            let _e112 = phi_824_;
            if _e112 {
                let _e115 = global_1.member[_e105.member];
                let _e120 = global_1.member[(_e105.member + 1u)];
                let _e125 = global_1.member[(_e105.member + 2u)];
                let _e130 = global_1.member[(_e105.member + 3u)];
                let _e136 = global_1.member[(_e105.member + 4u)];
                let _e141 = global_1.member[(_e105.member + 5u)];
                let _e146 = global_1.member[(_e105.member + 6u)];
                let _e151 = global_1.member[(_e105.member + 7u)];
                let _e157 = global_1.member[(_e105.member + 8u)];
                let _e162 = global_1.member[(_e105.member + 9u)];
                let _e167 = global_1.member[(_e105.member + 10u)];
                let _e172 = global_1.member[(_e105.member + 11u)];
                let _e178 = global_1.member[(_e105.member + 12u)];
                let _e183 = global_1.member[(_e105.member + 13u)];
                let _e188 = global_1.member[(_e105.member + 14u)];
                let _e193 = global_1.member[(_e105.member + 15u)];
                let _e200 = global_1.member[(_e105.member + 16u)];
                let _e205 = global_1.member[(_e105.member + 17u)];
                let _e210 = global_1.member[(_e105.member + 18u)];
                let _e215 = global_1.member[(_e105.member + 19u)];
                let _e221 = global_1.member[(_e105.member + 20u)];
                let _e226 = global_1.member[(_e105.member + 21u)];
                let _e231 = global_1.member[(_e105.member + 22u)];
                let _e236 = global_1.member[(_e105.member + 23u)];
                let _e242 = global_1.member[(_e105.member + 24u)];
                let _e247 = global_1.member[(_e105.member + 25u)];
                let _e252 = global_1.member[(_e105.member + 26u)];
                let _e257 = global_1.member[(_e105.member + 27u)];
                let _e263 = global_1.member[(_e105.member + 28u)];
                let _e268 = global_1.member[(_e105.member + 29u)];
                let _e273 = global_1.member[(_e105.member + 30u)];
                let _e278 = global_1.member[(_e105.member + 31u)];
                let _e285 = global_1.member[(_e105.member + 32u)];
                let _e290 = global_1.member[(_e105.member + 33u)];
                let _e295 = global_1.member[(_e105.member + 34u)];
                ...
                phi_326_ = type_12(0u, 6u);
                loop {
                    let _e300 = phi_326_;
                    if (_e300.member < _e300.member_1) {
                        phi_327_ = type_12((_e300.member + 1u), _e300.member_1);
                        phi_350_ = type_12(1u, _e300.member);
                    } else {
                        phi_327_ = _e300;
                        phi_350_ = type_12(0u, type_12().member_1);
                    }
                    let _e313 = phi_327_;
                    let _e315 = phi_350_;
                    switch bitcast<i32>(_e315.member) {
                        ...
                        case 1: {
                            ...
                            let _e323 = global_1.member[_e320];
                            let _e328 = global_1.member[(_e320 + 1u)];
                            let _e333 = global_1.member[(_e320 + 2u)];
                            let _e338 = global_1.member[(_e320 + 3u)];
                ...
                phi_383_ = type_12(0u, 8u);
                loop {
                    let _e348 = phi_383_;
                    if (_e348.member < _e348.member_1) {
                        phi_384_ = type_12((_e348.member + 1u), _e348.member_1);
                        phi_407_ = type_12(1u, _e348.member);
                    } else {
                        phi_384_ = _e348;
                        phi_407_ = type_12(0u, type_12().member_1);
                    }
                    let _e361 = phi_384_;
                    let _e363 = phi_407_;
                    switch bitcast<i32>(_e363.member) {
                        ...
                        case 1: {
                            ...
                            let _e371 = global_1.member[_e368];
                            let _e376 = global_1.member[(_e368 + 1u)];
                            let _e381 = global_1.member[(_e368 + 2u)];
                ...
                let _e388 = local;
                let _e392 = global_1.member[(_e105.member + 83u)];
                let _e397 = global_1.member[(_e105.member + 84u)];
                let _e402 = global_1.member[(_e105.member + 85u)];
                phi_451_ = type_23(type_21(vec4<f32>(bitcast<f32>(_e115), bitcast<f32>(_e120), bitcast<f32>(_e125), bitcast<f32>(_e130)), vec4<f32>(bitcast<f32>(_e136), bitcast<f32>(_e141), bitcast<f32>(_e146), bitcast<f32>(_e151)), vec4<f32>(bitcast<f32>(_e157), bitcast<f32>(_e162), bitcast<f32>(_e167), bitcast<f32>(_e172)), vec4<f32>(bitcast<f32>(_e178), bitcast<f32>(_e183), bitcast<f32>(_e188), bitcast<f32>(_e193))), type_21(vec4<f32>(bitcast<f32>(_e200), bitcast<f32>(_e205), bitcast<f32>(_e210), bitcast<f32>(_e215)), vec4<f32>(bitcast<f32>(_e221), bitcast<f32>(_e226), bitcast<f32>(_e231), bitcast<f32>(_e236)), vec4<f32>(bitcast<f32>(_e242), bitcast<f32>(_e247), bitcast<f32>(_e252), bitcast<f32>(_e257)), vec4<f32>(bitcast<f32>(_e263), bitcast<f32>(_e268), bitcast<f32>(_e273), bitcast<f32>(_e278))), vec3<f32>(bitcast<f32>(_e285), bitcast<f32>(_e290), bitcast<f32>(_e295)), type_22(_e388, _e345, vec3<f32>(bitcast<f32>(_e392), bitcast<f32>(_e397), bitcast<f32>(_e402))));
            } else {
                phi_451_ = type_23(type_21(vec4<f32>(1f, 0f, 0f, 0f), vec4<f32>(0f, 1f, 0f, 0f), vec4<f32>(0f, 0f, 1f, 0f), vec4<f32>(0f, 0f, 0f, 1f)), type_21(vec4<f32>(1f, 0f, 0f, 0f), vec4<f32>(0f, 1f, 0f, 0f), vec4<f32>(0f, 0f, 1f, 0f), vec4<f32>(0f, 0f, 0f, 1f)), vec3<f32>(0f, 0f, 0f), type_22(array<vec3<f32>, 8>(vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f)), array<vec4<f32>, 6>(vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f)), vec3<f32>(0f, 0f, 0f)));
            }
            let _e408 = phi_451_;
            if (_e87 >= 1u) {
            ...
            let _e415 = phi_856_;
            if _e415 {
                let _e418 = global_1.member[_e105.member_1];
