...
fn function() {
    ...
    switch bitcast<i32>(0u) {
        default: {
            ...
            let _e102 = phi_165_;
            if (_e84 >= 83u) {
                phi_811_ = (_e102.member <= (_e84 - 83u));
            } else {
                phi_811_ = false;
            }
            let _e109 = phi_811_;
            if _e109 {
                ...
                loop {
                    ...
                    if (_e297.member < _e297.member_1) {
                        ...
                        phi_350_ = type_24(1u, _e297.member);
                    } else {
                        phi_327_ = _e297;
                ...
                loop {
                    ...
                    if (_e345.member < _e345.member_1) {
                        phi_384_ = type_24((_e345.member + 1u), _e345.member_1);
