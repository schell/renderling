...
fn function() {
    ...
    var phi_718_: bool;
    var phi_517_: type_12;
    var phi_518_: type_12;
    var phi_541_: type_12;
    var phi_568_: bool;
    var phi_574_: type_12;
    var phi_575_: type_12;
    var phi_598_: type_12;
    var phi_621_: bool;
    var phi_642_: type_22;
    ...
    switch bitcast<i32>(0u) {
        default: {
            ...
            let _e89 = phi_718_;
            if _e89 {
                let _e92 = global.member[_e81];
                let _e97 = global.member[(_e81 + 1u)];
                let _e102 = global.member[(_e81 + 2u)];
                let _e107 = global.member[(_e81 + 3u)];
                let _e113 = global.member[(_e81 + 4u)];
                let _e118 = global.member[(_e81 + 5u)];
                let _e123 = global.member[(_e81 + 6u)];
                let _e128 = global.member[(_e81 + 7u)];
                let _e134 = global.member[(_e81 + 8u)];
                let _e139 = global.member[(_e81 + 9u)];
                let _e144 = global.member[(_e81 + 10u)];
                let _e149 = global.member[(_e81 + 11u)];
                let _e155 = global.member[(_e81 + 12u)];
                let _e160 = global.member[(_e81 + 13u)];
                let _e165 = global.member[(_e81 + 14u)];
                let _e170 = global.member[(_e81 + 15u)];
                let _e177 = global.member[(_e81 + 16u)];
                let _e182 = global.member[(_e81 + 17u)];
                let _e187 = global.member[(_e81 + 18u)];
                let _e192 = global.member[(_e81 + 19u)];
                let _e198 = global.member[(_e81 + 20u)];
                let _e203 = global.member[(_e81 + 21u)];
                let _e208 = global.member[(_e81 + 22u)];
                let _e213 = global.member[(_e81 + 23u)];
                let _e219 = global.member[(_e81 + 24u)];
                let _e224 = global.member[(_e81 + 25u)];
                let _e229 = global.member[(_e81 + 26u)];
                let _e234 = global.member[(_e81 + 27u)];
                let _e240 = global.member[(_e81 + 28u)];
                let _e245 = global.member[(_e81 + 29u)];
                let _e250 = global.member[(_e81 + 30u)];
                let _e255 = global.member[(_e81 + 31u)];
                let _e262 = global.member[(_e81 + 32u)];
                let _e267 = global.member[(_e81 + 33u)];
                let _e272 = global.member[(_e81 + 34u)];
                ...
                phi_517_ = type_12(0u, 6u);
                loop {
                    let _e277 = phi_517_;
                    if (_e277.member < _e277.member_1) {
                        phi_518_ = type_12((_e277.member + 1u), _e277.member_1);
                        phi_541_ = type_12(1u, _e277.member);
                    } else {
                        phi_518_ = _e277;
                        phi_541_ = type_12(0u, type_12().member_1);
                    }
                    let _e290 = phi_518_;
                    let _e292 = phi_541_;
                    switch bitcast<i32>(_e292.member) {
                        ...
                        case 1: {
                            ...
                            let _e300 = global.member[_e297];
                            let _e305 = global.member[(_e297 + 1u)];
                            let _e310 = global.member[(_e297 + 2u)];
                            let _e315 = global.member[(_e297 + 3u)];
                ...
                loop {
                    ...
                    if (_e325.member < _e325.member_1) {
                        phi_575_ = type_12((_e325.member + 1u), _e325.member_1);
                        phi_598_ = type_12(1u, _e325.member);
                    } else {
                        phi_575_ = _e325;
                        phi_598_ = type_12(0u, type_12().member_1);
                    }
                    let _e338 = phi_575_;
                    let _e340 = phi_598_;
                    switch bitcast<i32>(_e340.member) {
                        ...
                        case 1: {
                            ...
                            let _e348 = global.member[_e345];
                            let _e353 = global.member[(_e345 + 1u)];
                            let _e358 = global.member[(_e345 + 2u)];
                ...
                let _e365 = local;
                let _e369 = global.member[(_e81 + 83u)];
                let _e374 = global.member[(_e81 + 84u)];
                let _e379 = global.member[(_e81 + 85u)];
                phi_642_ = type_22(type_20(vec4<f32>(bitcast<f32>(_e92), bitcast<f32>(_e97), bitcast<f32>(_e102), bitcast<f32>(_e107)), vec4<f32>(bitcast<f32>(_e113), bitcast<f32>(_e118), bitcast<f32>(_e123), bitcast<f32>(_e128)), vec4<f32>(bitcast<f32>(_e134), bitcast<f32>(_e139), bitcast<f32>(_e144), bitcast<f32>(_e149)), vec4<f32>(bitcast<f32>(_e155), bitcast<f32>(_e160), bitcast<f32>(_e165), bitcast<f32>(_e170))), type_20(vec4<f32>(bitcast<f32>(_e177), bitcast<f32>(_e182), bitcast<f32>(_e187), bitcast<f32>(_e192)), vec4<f32>(bitcast<f32>(_e198), bitcast<f32>(_e203), bitcast<f32>(_e208), bitcast<f32>(_e213)), vec4<f32>(bitcast<f32>(_e219), bitcast<f32>(_e224), bitcast<f32>(_e229), bitcast<f32>(_e234)), vec4<f32>(bitcast<f32>(_e240), bitcast<f32>(_e245), bitcast<f32>(_e250), bitcast<f32>(_e255))), vec3<f32>(bitcast<f32>(_e262), bitcast<f32>(_e267), bitcast<f32>(_e272)), type_21(_e365, _e322, vec3<f32>(bitcast<f32>(_e369), bitcast<f32>(_e374), bitcast<f32>(_e379))));
            } else {
                phi_642_ = type_22(type_20(vec4<f32>(1f, 0f, 0f, 0f), vec4<f32>(0f, 1f, 0f, 0f), vec4<f32>(0f, 0f, 1f, 0f), vec4<f32>(0f, 0f, 0f, 1f)), type_20(vec4<f32>(1f, 0f, 0f, 0f), vec4<f32>(0f, 1f, 0f, 0f), vec4<f32>(0f, 0f, 1f, 0f), vec4<f32>(0f, 0f, 0f, 1f)), vec3<f32>(0f, 0f, 0f), type_21(array<vec3<f32>, 8>(vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f), vec3<f32>(0f, 0f, 0f)), array<vec4<f32>, 6>(vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f), vec4<f32>(0f, 0f, 0f, 0f)), vec3<f32>(0f, 0f, 0f)));
            }
            let _e385 = phi_642_;
